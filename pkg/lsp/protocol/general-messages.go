...
type InitializeFunc func(context *common.Context, params *InitializeParams) (any, error)
...
type InitializedFunc func(context *common.Context, params *InitializedParams) error
...
type LogTraceFunc func(context *common.Context, params *LogTraceParams) error
...
type SetTraceFunc func(context *common.Context, params *SetTraceParams) error

...
import "github.com/tislib/logi/pkg/lsp/common"
...
type WorkspaceDidChangeWorkspaceFoldersFunc func(context *common.Context, params *DidChangeWorkspaceFoldersParams) error
...
type WorkspaceDidChangeConfigurationFunc func(context *common.Context, params *DidChangeConfigurationParams) error
...
type WorkspaceDidChangeWatchedFilesFunc func(context *common.Context, params *DidChangeWatchedFilesParams) error
...
type WorkspaceSymbolFunc func(context *common.Context, params *WorkspaceSymbolParams) ([]SymbolInformation, error)
...
type WorkspaceExecuteCommandFunc func(context *common.Context, params *ExecuteCommandParams) (any, error)
...
type WorkspaceWillCreateFilesFunc func(context *common.Context, params *CreateFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidCreateFilesFunc func(context *common.Context, params *CreateFilesParams) error
...
type WorkspaceWillRenameFilesFunc func(context *common.Context, params *RenameFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidRenameFilesFunc func(context *common.Context, params *RenameFilesParams) error
...
type WorkspaceWillDeleteFilesFunc func(context *common.Context, params *DeleteFilesParams) (*WorkspaceEdit, error)
...
type WorkspaceDidDeleteFilesFunc func(context *common.Context, params *DeleteFilesParams) error

// https://microsoft.github.io/language-server-protocol/specifications/specification-3-16/#textDocument_semanticTokens
const MethodWorkspaceSemanticTokensRefresh = Method("workspace/semanticTokens/refresh")

type WorkspaceSemanticTokensRefreshFunc func(context *common.Context) error

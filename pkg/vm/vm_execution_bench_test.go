...
//		expectedDefinition *logiAst.Definition
//		options            []Option
//	}{
//		{
//			name: "simple macro",
...
//					logiAst.Definition, err := vm.GetlogiAst.DefinitionByName("VariableHoldUntil4")
//
//					if err != nil {
//						return err
//					}
...
//
//					for _, indicator := range logiAst.Definition.Data["indicators"]["indicators"].([]interface{}) {
...
//
//					f, err := vm.LocateCodeBlock(*logiAst.Definition, "strategy")
//
//					if err != nil {
//						return err
//					}
...
//				}
//
//				logiAst.Definitions, err := g.LoadLogiContent(tt.input)
//
//				if err != nil {
//					t.Errorf("error: %v", err)
//					return
...
//					assert.Len(t, logiAst.Definitions, 1)
//					if len(logiAst.Definitions) == 1 {
//						assert.Equal(t, *tt.expectedDefinition, logiAst.Definitions[0])
//					}
//				}
//
//				for pb.Next() {
